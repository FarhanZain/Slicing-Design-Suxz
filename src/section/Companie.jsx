    ...
    <>
      <section className="bg-[#F8F8FF] py-14 px-[30px] md:px-[64px] lg:px-[114px]">
        <div className="text-center">
          <h1 className="text-xl md:text-2xl lg:text-4xl font-extrabold font-manrope">
            Companies That Recruit Our Graduates
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl font-medium font-manrope mt-5">
            Our graduates have worked in more than 400 companies around the
            World
          </p>
        </div>
        <div className="grid grid-cols-2 gap-10 place-items-center mt-14 md:grid-cols-3 lg:grid-cols-4 lg:mx-60">
